...
class AlmacenEntradaController extends Controller
{
    ...
    {
        return AlmacenEntrada::with(['articulo', 'guardia', 'orden_servicio'])->get();
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'tipo_entrada' => 'required|in:Compra,Devolución de guardia,Devolución de servicio,Cambio de equipo,Reparación terminada,Otro',
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'tipo_entrada' => 'sometimes|in:Compra,Devolución de guardia,Devolución de servicio,Cambio de equipo,Reparación terminada,Otro',
            'otros_conceptos' => 'nullable|string',
            'orden_compra' => 'nullable|string',
        ]);

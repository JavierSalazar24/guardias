...
class ArticuloController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'articulo_equipar' => 'required|in:Guardia,Servicio,NO',
        ]);
    ...
    //  * Mostrar todos los registros.
    public function articulosAsignarGuardias()
    {
        $registros = Articulo::where('articulo_equipar', 'Guardia')->get();
        return response()->json($registros);
    }

    //  * Mostrar todos los registros.
    public function articulosAsignarServicios()
    {
        $registros = Articulo::where('articulo_equipar', 'Servicio')->get();
        return response()->json($registros);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'articulo_equipar' => 'sometimes|in:Guardia,Servicio,NO',
        ]);

...
class EstadoCuentaController extends Controller
{
    ...
    public function generarEstadoCuentaGuardia(Request $request)
    {
        $request->validate([
            ...
            'pago_empleado' => 'nullable|boolean',
        ]);
        ...
        $sueldoBaseQuincenal = (float) $guardia->sueldo_base;
        ...
        $diasLaboralesPeriodo = $diasLaboralesPorSemana * 2;
        ...
        $sueldoDiario = $sueldoBaseQuincenal / $diasLaboralesPeriodo;
        $pagoPorDiasTrabajados = round($diasTrabajados * $sueldoDiario, 2);
        $pagoPorDiasSinFalta = round($diasLaboralesPeriodo * $sueldoDiario, 2);
        ...
        $egresos = $totalFaltasMonto + $totalDescuentos + $incapNoPagadas + ($request->pago_empleado ? 0 : $saldoRestantePrestamosPendientes);
        ...
        return response()->json([
            'guardia' => [
                ...
                'sueldo_base_quincenal' => $sueldoBaseQuincenal,

...
class AlmacenSalidaController extends Controller
{
    ...
    {
        return AlmacenSalida::with(['articulo', 'guardia', 'orden_servicio'])->get();
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'orden_servicio_id' => 'nullable|exists:ordenes_servicios,id',
            'articulo_id' => 'required|exists:articulos,id',
            'numero_serie' => 'required|string',
            'fecha_salida' => 'required|date',
            'motivo_salida' => 'required|in:Asignado a guardia,Asignado a servicio,Devolución a proveedor,Venta,Destrucción,Mantenimiento,Robo,Pérdida,Otro',
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->validate([
            ...
            'motivo_salida' => 'sometimes|in:Asignado a guardia,Asignado a servicio,Devolución a proveedor,Venta,Destrucción,Mantenimiento,Robo,Pérdida,Otro',
            'motivo_salida_otro' => 'nullable|string',
        ]);

...
use App\Models\MotivoActaAdministrativa;
use Illuminate\Database\Eloquent\Factories\Factory;

class MotivoActaAdministrativaFactory extends Factory
{
    protected $model = MotivoActaAdministrativa::class;
    ...
    public function definition(): array
    {
        ...
        return $this->state($motivos[array_rand($motivos)]);
    }
}

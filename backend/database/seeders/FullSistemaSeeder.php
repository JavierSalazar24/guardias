...
class FullSistemaSeeder extends Seeder
{
    public function run(): void
    {
        $rutas = [
            ...
            'estadocuenta-bancos', 'generador-reportes', 'pagos-empleados', 'limpiezas-programadas', 'limpieza-logs', 'rangos', 'supervisiones',
            'motivos-actas', 'actas-administrativas', 'calendario', 'mantenimientos', 'talleres', 'tipos-documentos', 'documentos'
        ];

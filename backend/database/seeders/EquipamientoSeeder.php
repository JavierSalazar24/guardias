...
class EquipamientoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Obtener los artículos disponibles en almacén pero con el "articulo_equipar" del Articulo relacionado igual a "Guardia"
         $articulosDisponibles = Almacen::where('estado', 'Disponible')->whereHas('articulo', function ($query) {
            $query->where('articulo_equipar', 'Guardia');
        })->get();
        ...
        for ($i = 0; $i < 3; $i++) {
            ...
            foreach ($articulosAsignar as $almacen) {
                ...
                // 4. Actualiza el estado en almacén a "Asignado a guardia"
                $almacen->update(['estado' => 'Asignado a guardia']);
                ...
                AlmacenSalida::create([
                    ...
                    'motivo_salida' => 'Asignado a guardia',

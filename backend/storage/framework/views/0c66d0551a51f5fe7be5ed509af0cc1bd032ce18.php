...
<body>
    ...
    <div class="employee-info">
        <div class="employee-name">
            <?php echo e($pago->guardia->nombre); ?> <?php echo e($pago->guardia->apellido_p); ?> <?php echo e($pago->guardia->apellido_m); ?>

        </div>
        <div class="employee-number">
            Número de Empleado: <?php echo e($pago->guardia->numero_empleado); ?>

        </div>
        <div class="period-info">
            <span class="period-label">Período de Pago:</span><br>
            <span class="period-dates"><?php echo e(Carbon::parse($pago->periodo_inicio)->format('d/m/Y')); ?> - <?php echo e(Carbon::parse($pago->periodo_fin)->format('d/m/Y')); ?></span>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="amount-cell">$<?php echo e(number_format($pago->dias_trabajados, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Tiempo extra</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->tiempo_extra, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Prima vacacional</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->prima_vacacional, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Incapacidades pagadas</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->incapacidades_pagadas, 2)); ?> MXN</td>
                    </tr>
                    <tr class="total-row">
                        <td class="concept-cell">Total Ingresos</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->total_ingresos, 2)); ?> MXN</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="amount-cell">$<?php echo e(number_format($pago->descuentos, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Descuentos por faltas</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->faltas, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Incapacidades no pagadas</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->incapacidades_no_pagadas, 2)); ?> MXN</td>
                    </tr>
                    <tr class="total-row">
                        <td class="concept-cell">Total Egresos</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->total_egresos, 2)); ?> MXN</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="section">
        <h3 class="section-header retenciones">Retenciones Legales</h3>
        <div class="section-content">
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="amount-cell">$<?php echo e(number_format($pago->imss, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">INFONAVIT</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->infonavit, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">FONACOT</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->fonacot, 2)); ?> MXN</td>
                    </tr>
                    <tr>
                        <td class="concept-cell">Retención ISR</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->retencion_isr, 2)); ?> MXN</td>
                    </tr>
                    <tr class="total-row">
                        <td class="concept-cell">Total Retenciones</td>
                        <td class="amount-cell">$<?php echo e(number_format($pago->total_retenciones, 2)); ?> MXN</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="section-content">
            <div class="summary-cards">
                <div class="summary-card bruto">
                    ...
                    <div class="summary-card-amount">$<?php echo e(number_format($pago->pago_bruto, 2)); ?> MXN</div>
                ...
                <div class="summary-card final">
                    ...
                    <div class="summary-card-amount">$<?php echo e(number_format($pago->pago_final, 2)); ?> MXN</div>
    ...
    <div class="signature-section">
        <div class="signature-container">
            <div class="signature-box">
                ...
                <div class="signature-sublabel"><?php echo e($pago->guardia->nombre); ?> <?php echo e($pago->guardia->apellido_p); ?></div>
            </div>
            <div class="signature-box">
                <div class="signature-line"></div>
...
<?php /**PATH C:\Users\javie\OneDrive\Desktop\guardias\backend\resources\views/pdf/pago_empleado.blade.php ENDPATH**/ ?>
...
// Leer registros
export const getArticuloAsignarGuardias = async () => {
  try {
    const response = await apiClient.get('articulos-asignar-guardias')
    const { data } = response
...
export const getArticuloAsignarServicios = async () => {
  try {
    const response = await apiClient.get('articulos-asignar-servicios')
    const { data } = response

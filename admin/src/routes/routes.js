...
export const routes = [
  ...
  { path: '/rangos', label: 'Rangos', Icon: UserRoundPlus },
  {
    label: 'Personal',
    Icon: ShieldUser,
    children: [
      { label: 'Guardias', path: '/guardias' },
      { label: 'Supervisiones', path: '/supervisiones' },
      { label: 'Equipo asignado', path: '/equipo' },
      { label: 'Lista negra', path: '/blacklist' }
    ]
  },
  {
    label: 'Documentos guardias',
    Icon: Files,
    children: [
      { label: 'Tipo de documentos', path: '/tipos-documentos' },
  ...
  },
  {
    ...
    Icon: NotebookText,
    children: [
      { label: 'Motivos de actas', path: '/motivos-actas' },
      { label: 'Actas levantadas', path: '/actas-administrativas' }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/mantenimientos', label: 'Mantenimiento' },

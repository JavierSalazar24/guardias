...
export const useTiposServicios = () => {
  ...
  const { isLoading, isError, data, error } = useQuery({
    queryKey: ['tipos-servicios'],
    queryFn: getTipoServicio
  })

  const createMutation = useMutation({
    mutationFn: createTipoServicio,
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['tipos-servicios'] })

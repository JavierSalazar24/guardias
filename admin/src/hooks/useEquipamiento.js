...
import {
  getArticuloAsignarGuardias,
  getArticuloAsignarServicios
} from '../api/articulos'
...
export const useEquipamiento = () => {
  ...
  const {
    isLoading: loadArtiGuard,
    isError: errorArtiGuard,
    data: articulosGuardias
  } = useQuery({
    queryKey: ['articulos-asignar-guardias'],
    queryFn: getArticuloAsignarGuardias
  })

  const {
    isLoading: loadArtiServ,
    isError: errorArtiServ,
    data: articulosServicios
  } = useQuery({
    queryKey: ['articulos-asignar-servicios'],
    queryFn: getArticuloAsignarServicios
  })

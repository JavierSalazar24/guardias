...
const RangosPage = lazy(() => import('./pages/RangosPage'))
const GuardiasPage = lazy(() => import('./pages/GuardiasPage'))
const TiposDocumentosPage = lazy(() => import('./pages/TiposDocumentosPage'))
const DocumentosPage = lazy(() => import('./pages/DocumentosPage'))
const SupervisionesPage = lazy(() => import('./pages/SupervisionesPage'))
const EquipamientoPage = lazy(() => import('./pages/EquipamientoPage'))
const BlackListPage = lazy(() => import('./pages/BlackListPage'))
const MotivosActasPage = lazy(() => import('./pages/MotivosActasPage'))
const ActasAdministrativasPage = lazy(
  () => import('./pages/ActasAdministrativasPage')
)
...
const TalleresPage = lazy(() => import('./pages/TalleresPage'))
          ...
          <div className='flex-1 flex flex-col overflow-hidden'>
            ...
            <main className='flex-1 overflow-auto p-4'>
              <Routes>
                ...
                />
                <Route
                  path='/actas-administrativas'
                  element={
                    <PrivateRoute>
                      <ActasAdministrativasPage />
                    </PrivateRoute>
                  }
                />
                <Route

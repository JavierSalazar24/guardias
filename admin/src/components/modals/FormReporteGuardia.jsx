import { formOptions } from '../../forms/formReporteGuardiaOptions'
import { AlertaCard } from '../AlertaCard'
import { InputField } from '../InputField'

export const FormReporteGuardia = ({ view, formData, handleInputChange }) => {
  return (
            ...
            >
              <ul className='list-disc sm:pl-5 text-sm text-gray-800'>
                <li className='flex flex-col sm:list-item'>
                  ...
                  <strong>Observación {index + 1}:</strong> {observacion.texto}
                </li>
              </ul>
            </div>
          ))}
